...
public class MusicBox {
    public static void main(String[] args) {
        ...
        System.out.println("Please enter the music types: ");
        String musicTypes = scanner.nextLine().toLowerCase().trim();

        switch (musicTypes) {
            default:
                System.out.println(musicTypes+" music category is not available.");
            case "classical":
                ...
                switch (classicalSong) {
                    ...
                    case "the planets":
                        // add the $$$$$
                        System.out.println("Please provide payment for song, cost of song is $2.00");
                        double costClassical = scanner.nextDouble();
                        if (costClassical == 2) {
                            System.out.println("You are listening to " + classicalSong + ". Enjoy the song!");
                        } else if(costClassical < 2)
                        {while (costClassical < 2) {
                            System.out.println("Entered price is not enough, please add $"+ (2-costClassical)+ " more");
                            costClassical= scanner.nextDouble()+costClassical;}
                            if (costClassical>2){
                                System.out.println("You have entered $" + (costClassical - 2) + " more than required. Please enjoy the music while we processing your change!");
                                System.out.println("Here is your $"+ (costClassical - 2)+ "change.");
                            }else{
                                System.out.println("You are listening to " +costClassical + ". Enjoy the song!");
                            }
                        ...
                        break;
                    default:
                        System.out.println("The " + classicalSong + " is not available.");
                        break;
            ...
            case "pop":
                ...
                switch (popSong) {
                    ...
                    case "7 ring":
                    case "without me":
                        System.out.println("Please provide payment for song, cost of song is $4.00");
                        double costPop = scanner.nextDouble();
                        if (costPop == 4) {
                            System.out.println("You are listening to " + popSong + ". Enjoy the song!");
                        } else if (costPop < 4) {
                            while (costPop<4){
                                System.out.println("Entered price is not enough, please add $"+ (4-costPop)+ " more");
            ...
            case "country":
                ...
                switch (countrySong) {
                    ...
                    case "get along":
                    case "meant to be":
                        System.out.println("Please provide payment for song, cost of song is $3.00");
                        ...
                        if (costCountry == 3) {
                            ...
                            while(costCountry<3){
                                System.out.println("Entered price is not enough, please add $"+ (3-costCountry)+ " more");
                                costCountry= scanner.nextDouble()+costCountry;
                                if (costCountry>3){System.out.println("You have entered $" + (costCountry - 4) + " more than required. Please enjoy the music while we processing your change!");
                            ...
                            System.out.println("You have entered $" + (costCountry - 3) + " more than required. Please wait for the change.");
                        }
                        break;
